...
description: design and refine the structure, section order, responsive layout, and visual hierarchy of the uce website. use when creating or improving homepage sections, feature grids, architecture diagrams, cta placement, spacing, page flow, or engineering-oriented design patterns for a simple credible landing page.
---
...
Keep each capability distinct.

### CTA section
Make it easy to take one action.
Do not present too many competing actions.
...
- platform stack
- canonical model / validation / export flow
